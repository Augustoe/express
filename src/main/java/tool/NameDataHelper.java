...
public class NameDataHelper {
	...
	public NameDataHelper() {
		...
		Name[30] = "ji|积极济技击疾及基集记纪季继吉计冀祭际籍绩忌寂霁玑佶奇诘犄";
	...
	public static void main(String[] args) {
		...
		NameDataHelper chineseName = new NameDataHelper();
